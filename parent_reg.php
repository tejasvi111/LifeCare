	...
	<div class="limiter">
		<div class="container-login100">
			...
			<div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
				<form class="login100-form validate-form" action="preg_loc.php" method="post">
					...
					<div class="wrap-input100 validate-input" data-validate="Contact number is required">
						...
						<input class="input100" type="number" name="mob_num" placeholder="Mobile no...">
						<span class="focus-input100"></span>
					</div>
					...
					<div class="container-login100-form-btn">
						...
						<a href="parent_signin.php" class="dis-block txt3 hov1 p-r-30 p-t-10 p-b-10 p-l-30">
							Sign in
