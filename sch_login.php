	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="slogin_loc.php" method="post">
					<div class="wrap-input100 validate-input m-b-26" data-validate="School Id is required">
						...
						<input class="input100" type="text" name="sid" placeholder="Enter username">
